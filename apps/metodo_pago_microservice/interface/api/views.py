...
from apps.metodo_pago_microservice.domain.entities.request import RequestDTO
from apps.metodo_pago_microservice.application.use_cases import MotodoPagoUseCases
from apps.metodo_pago_microservice.infrastructure.repositories import MotodoPagoRepository
from apps.metodo_pago_microservice.interface.serializers.metodo_pago_create_serializers import MetodoPagoCreateSerializer
from apps.metodo_pago_microservice.interface.serializers.metodo_pago_update_serializers import MetodoPagoUpdateSerializer

class MotodoPagoViewSet(viewsets.ViewSet):
    """
    ...
    def __init__(self, **kwargs):
        ...
        self.repository = MotodoPagoRepository()
        self.use_cases = MotodoPagoUseCases(self.repository)

    def list(self, request):
        response_dto = self.use_cases.get_metodos_pago()
    ...
    def retrieve(self, request, pk=None):
        response_dto = self.use_cases.get_metodo_pago(int(pk))
    ...
    def create(self, request):
        ...
        serializer = MetodoPagoCreateSerializer(data=request.data)
        ...
        response_dto = self.use_cases.create_metodo_pago(request_dto)
    ...
    def update(self, request, pk=None):
        '''
        Actualiza un Metodo de Pago en el Sistema
        '''

        # Validar los Datos de Entrada
        serializer = MetodoPagoUpdateSerializer(data=request.data)
        serializer.is_valid(raise_exception=True)
        ...
        response_dto = self.use_cases.update_metodo_pago(int(pk), request_dto)
    ...
    def destroy(self, request, pk=None):
        ...
        response_dto = self.use_cases.delete_metodo_pago(int(pk))
