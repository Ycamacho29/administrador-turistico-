...
from apps.idioma_microservice.domain.entities.request import RequestDTO
from apps.idioma_microservice.application.use_cases import IdiomaUseCases
from apps.idioma_microservice.infrastructure.repositories import IdiomaRepository
from apps.idioma_microservice.interface.serializers.idioma_create_serializers import IdiomaCreateSerializer
from apps.idioma_microservice.interface.serializers.idioma_update_serializers import IdiomaUpdateSerializer

class IdiomaViewSet(viewsets.ViewSet):
    """
    ...
    def __init__(self, **kwargs):
        ...
        self.repository = IdiomaRepository()
        self.use_cases = IdiomaUseCases(self.repository)

    def list(self, request):
        response_dto = self.use_cases.get_idiomas()
    ...
    def retrieve(self, request, pk=None):
        response_dto = self.use_cases.get_idioma(int(pk))
    ...
    def create(self, request):
        ...
        serializer = IdiomaCreateSerializer(data=request.data)
        ...
        response_dto = self.use_cases.create_idioma(request_dto)
    ...
    def update(self, request, pk=None):
        '''
        Actualiza un Idioma en el Sistema
        '''

        # Validar los Datos de Entrada
        serializer = IdiomaUpdateSerializer(data=request.data)
        serializer.is_valid(raise_exception=True)
        ...
        response_dto = self.use_cases.update_idioma(int(pk), request_dto)
    ...
    def destroy(self, request, pk=None):
        '''Elimina una Ciudad'''
        response_dto = self.use_cases.delete_idioma(int(pk))
