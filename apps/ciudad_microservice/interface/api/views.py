...
from apps.ciudad_microservice.domain.entities.request import RequestDTO
from apps.ciudad_microservice.application.use_cases import CiudadUseCases
from apps.ciudad_microservice.infrastructure.repositories import CiudadRepository
from apps.ciudad_microservice.interface.serializers.ciudad_create_serializers import CiudadCreateRequestSerializer
from apps.ciudad_microservice.interface.serializers.ciudad_update_serializers import CiudadUpdateSerializer
...
class CiudadViewSet(viewsets.ViewSet):
    ...
    def __init__(self, **kwargs):
        ...
        self.use_cases = CiudadUseCases(self.repository)

    def list(self, request):
        response_dto = self.use_cases.get_ciudades()
    ...
    def retrieve(self, request, pk=None):
        response_dto = self.use_cases.get_ciudad(int(pk))
    ...
    def create(self, request):
        ...
        serializer = CiudadCreateRequestSerializer(data=request.data)
        ...
        response_dto = self.use_cases.create_ciudad(request_dto)
    ...
    def update(self, request, pk=None):
        '''
        Actualiza una Ciudad en el Sistema
        '''

        # Validar los Datos de Entrada
        serializer = CiudadUpdateSerializer(data=request.data)
        serializer.is_valid(raise_exception=True)
        ...
        response_dto = self.use_cases.update_ciudad(int(pk), request_dto)
    ...
    def destroy(self, request, pk=None):
        '''Elimina una Ciudad'''
        response_dto = self.use_cases.delete_ciudad(int(pk))
