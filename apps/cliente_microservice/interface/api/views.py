...
from apps.cliente_microservice.domain.entities.request import RequestDTO
from apps.cliente_microservice.application.use_cases import ClienteUseCases
from apps.cliente_microservice.infrastructure.repositories import ClienteRepository
from apps.cliente_microservice.interface.serializers.cliente_create_serializers import ClienteCreateSerializer
...
class ClienteViewSet(viewsets.ViewSet):
    ...
    def __init__(self, **kwargs):
        ...
        self.use_cases = ClienteUseCases(self.repository)

    def list(self, request):
        response_dto = self.use_cases.get_clientes()
    ...
    def retrieve(self, request, pk=None):
        response_dto = self.use_cases.get_cliente(int(pk))
    ...
    def create(self, request):
        ...
        response_dto = self.use_cases.create_cliente(request_dto)
    ...
    def update(self, request, pk=None):
        '''
        Actualiza un Cliete en el Sistema
        '''
        ...
        response_dto = self.use_cases.update_cliente(int(pk), request_dto)
    ...
    def destroy(self, request, pk=None):
        '''Elimina un Cliente'''
        response_dto = self.use_cases.delete_cliente(int(pk))
