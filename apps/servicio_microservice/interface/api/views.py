...
from apps.servicio_microservice.domain.entities.request import RequestDTO
from apps.servicio_microservice.application.use_cases import ServicioUseCases
from apps.servicio_microservice.infrastructure.repositories import ServicioRepository
from apps.servicio_microservice.interface.serializers.servicio_create_serializers import ServicioCreateSerializer
from apps.servicio_microservice.interface.serializers.servicio_update_serializers import ServicioUpdateSerializer
...
class ServicioViewSet(viewsets.ViewSet):
    ...
    def __init__(self, **kwargs):
        ...
        self.use_cases = ServicioUseCases(self.repository)

    def list(self, request):
        response_dto = self.use_cases.get_servicios()
    ...
    def retrieve(self, request, pk=None):
        response_dto = self.use_cases.get_servicio(int(pk))
    ...
    def create(self, request):
        ...
        serializer = ServicioCreateSerializer(data=request.data)
        ...
        response_dto = self.use_cases.create_servicio(request_dto)
    ...
    def update(self, request, pk=None):
        ...
        serializer = ServicioUpdateSerializer(data=request.data)
        serializer.is_valid(raise_exception=True)
        ...
        response_dto = self.use_cases.update_servicio(int(pk), request_dto)
    ...
    def destroy(self, request, pk=None):
        '''Elimina una Ciudad'''
        response_dto = self.use_cases.delete_servicio(int(pk))
