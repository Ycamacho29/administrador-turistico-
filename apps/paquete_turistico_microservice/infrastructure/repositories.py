...
class PaqueteTuristicoRepository:
    ...
    def guardar_paquete_turistico(self, datos: dict) -> PaqueteTuristico:
        """
    ...
    def actualizar_paquete_turistico(self, paquete_turistico_id: int, datos: dict) -> PaqueteTuristico:
